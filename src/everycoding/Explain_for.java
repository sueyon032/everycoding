...
public class Explain_for extends JFrame {
	private Image for_explain = new ImageIcon(Main.class.getResource("../images/for_explain.png")).getImage(); // 그림경로
	...
	public void paint(Graphics g) {
		g.drawImage(for_explain, 0, 0, null);
	}
