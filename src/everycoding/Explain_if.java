...
public class Explain_if extends JFrame {
	private Image if_explain = new ImageIcon(Main.class.getResource("../images/if_explain.png")).getImage(); // 그림경로
	...
	public void paint(Graphics g) {
		g.drawImage(if_explain, 0, 0, null);
	}
