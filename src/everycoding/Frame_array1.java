...
public class Frame_array1 extends JFrame {
	...
	public void paint(Graphics g) {
		...
		case 0:
			...
			checkbutton.addMouseListener(new MouseAdapter() {
				@Override
				public void mousePressed(MouseEvent e) { // 마우스가 체크박스를 눌러을 때의 액션
					if (answer.getText().equals("new int[100]")) { // getText: 현재 텍스트필드에 입력된 문자열을 읽어온다=> 그것이 답과 같다면
																	// Answer_correct을 띄워라
						new Answer_correct();
						setVisible(false);
					} else {
